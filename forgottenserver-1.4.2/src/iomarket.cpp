...
extern Game g_game;
auto format_as(AccessList_t accessEnum) { return static_cast<int>(accessEnum); }

template <class enumType> int format_as(enumType accessEnum)
{
	return static_cast<int>(accessEnum);
}
